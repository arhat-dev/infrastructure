...
__NOTE:__ Chart dependencies in this repository are updated weekly according to the the [renovate dashboard](https://github.com/arhat-dev/helm-charts/issues/2), please do not send pull request for chart upgrade.
